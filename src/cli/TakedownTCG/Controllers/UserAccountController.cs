...
namespace TakedownTCG.cli.Controllers
{
    public static class UserAccountController
    {
        ...
        private static readonly FavoriteService _favoriteService;
        private static User? _currentUser;

        public static User? CurrentUser => _currentUser;
        public static FavoriteService FavoriteService => _favoriteService;
        ...
        static UserAccountController()
        {
            ...
            _accountService = new AccountService(userRepo);
            _favoriteService = new FavoriteService(new FavoriteRepository(dbPath), userRepo);
            _currentUser = null;
        }
